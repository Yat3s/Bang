...
public class OPDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public OPDividerItemDecoration(Context context, Drawable divider) {
        this.context = context;
        this.divider = divider;
    }

    public OPDividerItemDecoration(Context context) {
        this.context = context;
